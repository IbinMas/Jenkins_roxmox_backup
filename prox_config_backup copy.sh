...
BACKUP_DIR=${BACK_DIR:-$DEFAULT_BACK_BACK_DIR}
...
create_backup "$TEMP_DIR/backup/etc-pve" "$TEMP_DIR/backup/etc-pve-backup.tar.gz"
create_backup "$TEMP_DIR/backup/var-lib-pve-cluster" "$TEMP_DIR/backup/var-lib-pve-cluster-backup.tar.gz"
create_backup "$TEMP_DIR/backup/etc-corosync" "$TEMP_DIR/backup/etc-corosync-backup.tar.gz"
...
tar -tf "$TEMP_DIR/backup/etc-pve-backup.tar.gz"
tar -tf "$TEMP_DIR/backup/var-lib-pve-cluster-backup.tar.gz"
tar -tf "$TEMP_DIR/backup/etc-corosync-backup.tar.gz"
